...
const char HTTP_FORM_START[] PROGMEM      = "<form method='get' action='wifisave'><input id='s' name='s' length=32 placeholder='SSID'><br/><input id='p' name='p' length=64 type='text' placeholder='password'><br/>";
...
class WiFiManager
{
  ...
  private:
    ...
    const char*   _apName                 = "Ekhiw Device";
